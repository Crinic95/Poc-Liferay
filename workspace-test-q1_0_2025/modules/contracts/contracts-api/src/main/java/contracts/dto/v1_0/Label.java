 ...
 */
@Generated("")
@GraphQLName(description = "Represents a static label.", value = "Label")
...
public class Label implements Serializable {
	...
	@Schema(description = "the label text")
	...
	@GraphQLField(description = "the label text")
	...
	@Schema(
		...
		defaultValue = "contracts.dto.v1_0.Label", name = "x-class-name"
	)
