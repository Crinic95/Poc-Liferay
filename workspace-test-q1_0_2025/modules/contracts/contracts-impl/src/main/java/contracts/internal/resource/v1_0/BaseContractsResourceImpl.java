...
public abstract class BaseContractsResourceImpl implements ContractsResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/contracts/v1.0/label'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Contracts")}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/label")
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseContractsResourceImpl.class);
